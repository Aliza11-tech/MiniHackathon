...
export default function Mehran(){
    return(
        <div className="bg-white text-black">
            <h1 className="bg-white text-black text-center font-bold text-3xl">SUZUKI MEHRAN CAR DETAILS</h1>
            <br />
...
src="/images/mehran1.png"
 ...
 className="items-center h-44 w-[600px]" />
        ...
        <p className=" text-center text-lg py-4 px-4">The Suzuki Mehran is a popular choice for drivers looking for
